...
<div class="form-group col-sm-6">
    <div class="form-check">
        {!! Form::hidden('is_subscribe', 0, ['class' => 'form-check-input']) !!}
        {!! Form::checkbox('is_subscribe', '1', null, ['class' => 'form-check-input']) !!}
        {!! Form::label('is_subscribe', 'Is Subscribe', ['class' => 'form-check-label']) !!}
    </div>
</div>
